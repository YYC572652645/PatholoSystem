/********************************************************************************
** Form generated from reading UI file 'newimmuneslice.ui'
**
...
#ifndef UI_NEWIMMUNESLICE_H
#define UI_NEWIMMUNESLICE_H
...
public:
    ...
    void setupUi(QMainWindow *newimmuneslice)
    {
        if (newimmuneslice->objectName().isEmpty())
            newimmuneslice->setObjectName(QStringLiteral("newimmuneslice"));
        newimmuneslice->resize(600, 496);
        newimmuneslice->setMinimumSize(QSize(600, 496));
        newimmuneslice->setMaximumSize(QSize(600, 496));
        centralwidget = new QWidget(newimmuneslice);
        ...
        newimmuneslice->setCentralWidget(centralwidget);

        retranslateUi(newimmuneslice);

        QMetaObject::connectSlotsByName(newimmuneslice);
    } // setupUi

    void retranslateUi(QMainWindow *newimmuneslice)
    {
        newimmuneslice->setWindowTitle(QApplication::translate("newimmuneslice", "MainWindow", 0));
        groupBox->setTitle(QString());
        label->setText(QApplication::translate("newimmuneslice", "\346\235\220\345\235\227\347\274\226\345\217\267\357\274\232", 0));
        label_2->setText(QApplication::translate("newimmuneslice", "\346\211\223\345\215\260\346\225\260\351\207\217\357\274\232", 0));
        label_3->setText(QApplication::translate("newimmuneslice", "\346\237\223\350\211\262\347\261\273\345\236\213\357\274\232", 0));
        label_4->setText(QApplication::translate("newimmuneslice", "\346\237\223\350\211\262\346\214\207\346\240\207\357\274\232", 0));
        label_5->setText(QApplication::translate("newimmuneslice", "\345\205\213\351\232\206\345\217\267\347\240\201\357\274\232", 0));
        label_6->setText(QApplication::translate("newimmuneslice", "\345\210\207\347\211\207\344\272\272\357\274\232", 0));
        label_7->setText(QApplication::translate("newimmuneslice", "\345\210\207\347\211\207\346\227\266\351\227\264\357\274\232", 0));
        label_9->setText(QApplication::translate("newimmuneslice", "\346\237\223\350\211\262\344\272\272\357\274\232", 0));
        label_8->setText(QApplication::translate("newimmuneslice", "\346\237\223\350\211\262\346\227\266\351\227\264\357\274\232", 0));
        pushButtonOk->setText(QApplication::translate("newimmuneslice", "\347\241\256\345\256\232", 0));
        pushButtonCancel->setText(QApplication::translate("newimmuneslice", "\345\217\226\346\266\210", 0));
    } // retranslateUi

};

namespace Ui {
    class newimmuneslice: public Ui_newimmuneslice {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_NEWIMMUNESLICE_H
