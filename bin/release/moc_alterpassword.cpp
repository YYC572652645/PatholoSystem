...
const QMetaObject AlterPassword::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_AlterPassword.data,
      qt_meta_data_AlterPassword,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *AlterPassword::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AlterPassword.stringdata0))
