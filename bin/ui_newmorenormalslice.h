/********************************************************************************
** Form generated from reading UI file 'newmorenormalslice.ui'
**
...
#ifndef UI_NEWMORENORMALSLICE_H
#define UI_NEWMORENORMALSLICE_H
...
public:
    ...
    QLabel *label_5;
    QLineEdit *lineEditRSType;
    QSpacerItem *horizontalSpacer_13;
    QLabel *label_6;
    QLineEdit *lineEditRSIndex;
    ...
    void setupUi(QMainWindow *newmorenormalslice)
    {
        if (newmorenormalslice->objectName().isEmpty())
            newmorenormalslice->setObjectName(QStringLiteral("newmorenormalslice"));
        newmorenormalslice->resize(627, 512);
        newmorenormalslice->setMinimumSize(QSize(627, 512));
        newmorenormalslice->setMaximumSize(QSize(627, 512));
        centralwidget = new QWidget(newmorenormalslice);
        ...
        lineEditRSType = new QLineEdit(groupBox);
        lineEditRSType->setObjectName(QStringLiteral("lineEditRSType"));
        lineEditRSType->setMinimumSize(QSize(180, 0));
        lineEditRSType->setMaximumSize(QSize(180, 16777215));

        horizontalLayout_5->addWidget(lineEditRSType);
        ...
        lineEditRSIndex = new QLineEdit(groupBox);
        lineEditRSIndex->setObjectName(QStringLiteral("lineEditRSIndex"));
        lineEditRSIndex->setMinimumSize(QSize(180, 0));
        lineEditRSIndex->setMaximumSize(QSize(180, 16777215));

        horizontalLayout_5->addWidget(lineEditRSIndex);
        ...
        lineEditOther = new QLineEdit(groupBox);
        lineEditOther->setObjectName(QStringLiteral("lineEditOther"));

        horizontalLayout_4->addWidget(lineEditOther);
        ...
        newmorenormalslice->setCentralWidget(centralwidget);
        ...
        QWidget::setTabOrder(spinBoxPrintNumber, lineEditRSType);
        QWidget::setTabOrder(lineEditRSType, lineEditRSIndex);
        QWidget::setTabOrder(lineEditRSIndex, lineEditOther);
        ...
        retranslateUi(newmorenormalslice);

        QMetaObject::connectSlotsByName(newmorenormalslice);
    } // setupUi

    void retranslateUi(QMainWindow *newmorenormalslice)
    {
        newmorenormalslice->setWindowTitle(QApplication::translate("newmorenormalslice", "MainWindow", 0));
        groupBox->setTitle(QString());
        label->setText(QApplication::translate("newmorenormalslice", "\347\227\205\347\220\206\345\217\267\357\274\232", 0));
        label_2->setText(QApplication::translate("newmorenormalslice", "\345\242\236\345\212\240\346\225\260\351\207\217\357\274\232", 0));
        radioButtonAddBLNumber->setText(QApplication::translate("newmorenormalslice", "\344\273\205\351\200\222\345\242\236\345\272\217\345\217\267", 0));
        radioButtonAddBlAndCode->setText(QApplication::translate("newmorenormalslice", "\344\273\205\351\200\222\345\242\236\347\227\205\347\220\206\345\217\267\344\270\224\345\270\246\345\272\217\345\217\267", 0));
        radioButtonAddBlAndCancel->setText(QApplication::translate("newmorenormalslice", "\344\273\205\351\200\222\345\242\236\347\227\205\347\220\206\345\217\267\357\274\214\344\270\224\345\217\226\346\266\210\345\272\217\345\217\267", 0));
        radioButtonAddAll->setText(QApplication::translate("newmorenormalslice", "\347\227\205\347\220\206\345\217\267\345\217\212\345\272\217\345\217\267\345\220\214\346\227\266\345\242\236\345\212\240", 0));
        label_4->setText(QApplication::translate("newmorenormalslice", "\346\211\223\345\215\260\346\225\260\351\207\217\357\274\232", 0));
        label_5->setText(QApplication::translate("newmorenormalslice", "\346\237\223\350\211\262\347\261\273\345\236\213\357\274\232", 0));
        lineEditRSType->setText(QApplication::translate("newmorenormalslice", "\345\270\270\350\247\204", 0));
        label_6->setText(QApplication::translate("newmorenormalslice", "\346\237\223\350\211\262\346\214\207\346\240\207\357\274\232", 0));
        lineEditRSIndex->setText(QApplication::translate("newmorenormalslice", "HE", 0));
        label_11->setText(QApplication::translate("newmorenormalslice", "\345\205\266\344\273\226\357\274\232", 0));
        label_7->setText(QApplication::translate("newmorenormalslice", "\345\210\207\347\211\207\344\272\272\357\274\232", 0));
        label_9->setText(QApplication::translate("newmorenormalslice", "\345\210\207\347\211\207\346\227\266\351\227\264\357\274\232", 0));
        label_8->setText(QApplication::translate("newmorenormalslice", "\346\237\223\350\211\262\344\272\272\357\274\232", 0));
        label_10->setText(QApplication::translate("newmorenormalslice", "\346\237\223\350\211\262\346\227\266\351\227\264\357\274\232", 0));
        pushButtonOk->setText(QApplication::translate("newmorenormalslice", "\347\241\256\345\256\232", 0));
        pushButtonCancel->setText(QApplication::translate("newmorenormalslice", "\345\217\226\346\266\210", 0));
    } // retranslateUi

};

namespace Ui {
    class newmorenormalslice: public Ui_newmorenormalslice {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_NEWMORENORMALSLICE_H
