...
public:
    ...
    void setupUi(QWidget *specialindexset)
    {
        ...
        specialindexset->resize(614, 611);
...
"}"));
        ...
        pushButtonPrint = new QPushButton(specialindexset);
...
"}"));
        ...
        pushButtonPrintAll = new QPushButton(specialindexset);
...
"}"));
        ...
        pushButtonTemplateSet = new QPushButton(specialindexset);
...
"}"));
    ...
    void retranslateUi(QWidget *specialindexset)
    {
        ...
        pushButtonPrint->setText(QApplication::translate("specialindexset", "\346\211\223\345\215\260\346\240\207\347\255\276", 0));
        pushButtonPrintAll->setText(QApplication::translate("specialindexset", "\345\205\250\351\203\250\346\211\223\345\215\260", 0));
        pushButtonTemplateSet->setText(QApplication::translate("specialindexset", "\350\256\276\347\275\256\346\250\241\346\235\277", 0));
